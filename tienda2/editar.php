<?php
 include ('config/db.php');
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
       $name = $_POST['name'];
        $resultt = mysqli_query($conexion,"UPDATE productos SET name = '$name' where id= '$id'");
        if($resultt){
...
<html lang="es">
  ...
  <body>
      ...
      <br>
      <input type="text" placeholder="Nombre" value="<?php echo $row['name'];?>" name="name" class="form-control">
      <br>
